...
public final class ComboActionIcons {
    ...
    static {
        ...
        ICON_FOR_ACTION.put(ComboDispatcher.A_SCROLL_LEFT,    R.drawable.gw_action_scroll_left_24dp);
        ICON_FOR_ACTION.put(ComboDispatcher.A_SCROLL_RIGHT,   R.drawable.gw_action_scroll_right_24dp);
        ICON_FOR_ACTION.put(ComboDispatcher.A_SCROLL_TOP,     R.drawable.gw_action_scroll_top_24dp);
        ICON_FOR_ACTION.put(ComboDispatcher.A_SCROLL_BOTTOM,  R.drawable.gw_action_scroll_bottom_24dp);
        ...
        ICON_FOR_ACTION.put(ComboDispatcher.A_STOP,           R.drawable.gw_action_stop_24dp);
        ...
        ICON_FOR_ACTION.put(ComboDispatcher.A_DUPLICATE,      R.drawable.gw_action_duplicate_window_24dp);
        ...
        ICON_FOR_ACTION.put(ComboDispatcher.A_READER_MODE,    R.drawable.gw_action_reader_mode_24dp);
    ...
    public static @DrawableRes int iconFor(int actionInt) {
        return ICON_FOR_ACTION.get(actionInt, R.drawable.gw_action_unknown_24dp);
    }
}
